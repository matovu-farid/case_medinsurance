...
class DependantsStore {
  ...
  var _dependants = <Dependant>[];
  List<Dependant> get dependants => this._dependants;

  void addToDependants(Dependant dependant) {
    _dependants.add(dependant);
  }
}

class DependantSaver {
  var _dependant = Dependant();
  Dependant get dependant => _dependant;
